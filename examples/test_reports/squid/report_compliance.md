...
| EU CRA | 6 | 29 | 13 | 0 |
| DORA | 6 | 12 | 2 | 0 |
| ISO/IEC 27001 | 6 | 12 | 4 | 0 |
| ISO/IEC 42001 | 3 | 6 | 2 | 0 |
...
- **Client:** `client_b2076b41`
- **Queries:** 18 (3.0/Tag)
- **Upload:** 1× Dokument-Upload (1144.3 KB)
...
| **EU_AI_ACT** | `Art. 9` (Risk Management System) | high | non_compliant | KI-Dienst 'Cursor' mit Risk-Score 95 ohne Risk-Management-System. |
...
- **Risk:** high (Score 75)
- **Client:** `client_46c0b28c`
- **Queries:** 5 (0.8/Tag)
- **Upload:** 2× Dokument-Upload (2623.3 KB)
| Framework | Control | Severity | Status | Begründung |
|---|---|---|---|---|
...
| **EU_AI_ACT** | `Art. 9` (Risk Management System) | high | non_compliant | KI-Dienst 'Google Gemini' mit Risk-Score 75 ohne Risk-Management-System. |
...
| **EU_AI_ACT** | `Art. 9` (Risk Management System) | high | non_compliant | KI-Dienst 'DeepSeek' mit Risk-Score 75 ohne Risk-Management-System. |
...
- **Client:** `client_b2076b41`
- **Queries:** 8 (1.3/Tag)
- **Upload:** 2× Dokument-Upload (3596.0 KB)
| Framework | Control | Severity | Status | Begründung |
|---|---|---|---|---|
...
| **EU_AI_ACT** | `Art. 9` (Risk Management System) | high | non_compliant | KI-Dienst 'OpenAI ChatGPT' mit Risk-Score 75 ohne Risk-Management-System. |
...
- **Client:** `client_b2076b41`
- **Queries:** 17 (2.8/Tag)
- **Upload:** 1× Dokument-Upload (2316.2 KB)
| Framework | Control | Severity | Status | Begründung |
|---|---|---|---|---|
...
| **EU_AI_ACT** | `Art. 9` (Risk Management System) | high | non_compliant | KI-Dienst 'Perplexity AI' mit Risk-Score 75 ohne Risk-Management-System. |
...
| **EU_AI_ACT** | `Art. 9` (Risk Management System) | high | non_compliant | KI-Dienst 'GitHub Copilot' mit Risk-Score 75 ohne Risk-Management-System. |
...
- **Client:** `client_ef483e4a`
- **Queries:** 12 (2.0/Tag)
- **Upload:** 3× Dokument-Upload (4904.3 KB)
| Framework | Control | Severity | Status | Begründung |
|---|---|---|---|---|
| **ISO_27001** | `A.5.9` (Inventory of Information and Other Associated Assets) | high | non_compliant | Nicht-inventarisierter KI-Dienst 'OpenAI ChatGPT' von OpenAI erkannt. |
| **ISO_27001** | `A.5.23` (Information Security for Use of Cloud Services) | high | non_compliant | Cloud-basierter KI-Dienst 'OpenAI ChatGPT' ohne Sicherheitsbewertung genutzt. |
...
- **Client:** `client_b2076b41`
- **Queries:** 4 (4.0/Tag)
- **Upload:** 2× Dokument-Upload (2850.5 KB)
| Framework | Control | Severity | Status | Begründung |
|---|---|---|---|---|
...
| **EU_AI_ACT** | `Art. 9` (Risk Management System) | high | partially_compliant | KI-Dienst 'OpenAI ChatGPT' mit Risk-Score 55 ohne Risk-Management-System. |
...
| Framework | Control | Severity | Status | Begründung |
|---|---|---|---|---|
| **ISO_27001** | `A.5.9` (Inventory of Information and Other Associated Assets) | medium | needs_review | Nicht-inventarisierter KI-Dienst 'DeepL' von DeepL erkannt. |
| **ISO_27001** | `A.5.23` (Information Security for Use of Cloud Services) | medium | needs_review | Cloud-basierter KI-Dienst 'DeepL' ohne Sicherheitsbewertung genutzt. |
| **DORA** | `Art. 28` (ICT Third-Party Risk) | medium | needs_review | Nicht-autorisierter ICT-Drittanbieter 'DeepL' (DeepL) im Einsatz. |
| **ISO_42001** | `6.1.2` (AI Risk Assessment) | medium | needs_review | KI-Dienst 'DeepL' ohne AI-Risikobewertung im Einsatz. |
| **DSGVO** | `Art. 6` (Rechtmäßigkeit der Verarbeitung) | medium | needs_review | Datenverarbeitung durch 'DeepL' (DeepL) ohne Rechtsgrundlage. |
| **DSGVO** | `Art. 25` (Datenschutz durch Technikgestaltung) | medium | needs_review | KI-Dienst 'DeepL' ohne Privacy-by-Design-Bewertung. |
| **CRA** | `Art. 6` (Essential Cybersecurity Requirements) | medium | needs_review | KI-Dienst 'DeepL' als Produkt mit digitalen Elementen ohne CE-Konformitätserklärung nach CRA. |
| **CRA** | `Art. 24` (Technical Documentation) | medium | needs_review | Cloud-KI-Dienst 'DeepL' ohne technische Dokumentation nach CRA-Anhang V. |
...
| Framework | Control | Severity | Status | Begründung |
|---|---|---|---|---|
| **ISO_27001** | `A.5.9` (Inventory of Information and Other Associated Assets) | medium | needs_review | Nicht-inventarisierter KI-Dienst 'Grammarly AI' von Grammarly erkannt. |
| **ISO_27001** | `A.5.23` (Information Security for Use of Cloud Services) | medium | needs_review | Cloud-basierter KI-Dienst 'Grammarly AI' ohne Sicherheitsbewertung genutzt. |
| **DORA** | `Art. 28` (ICT Third-Party Risk) | medium | needs_review | Nicht-autorisierter ICT-Drittanbieter 'Grammarly AI' (Grammarly) im Einsatz. |
| **ISO_42001** | `6.1.2` (AI Risk Assessment) | medium | needs_review | KI-Dienst 'Grammarly AI' ohne AI-Risikobewertung im Einsatz. |
| **DSGVO** | `Art. 6` (Rechtmäßigkeit der Verarbeitung) | medium | needs_review | Datenverarbeitung durch 'Grammarly AI' (Grammarly) ohne Rechtsgrundlage. |
| **DSGVO** | `Art. 25` (Datenschutz durch Technikgestaltung) | medium | needs_review | KI-Dienst 'Grammarly AI' ohne Privacy-by-Design-Bewertung. |
| **CRA** | `Art. 6` (Essential Cybersecurity Requirements) | medium | needs_review | KI-Dienst 'Grammarly AI' als Produkt mit digitalen Elementen ohne CE-Konformitätserklärung nach CRA. |
| **CRA** | `Art. 24` (Technical Documentation) | medium | needs_review | Cloud-KI-Dienst 'Grammarly AI' ohne technische Dokumentation nach CRA-Anhang V. |

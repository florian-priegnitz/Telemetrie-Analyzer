"""CI-Branding für Streamlit-Apps (Bauhaus-Stil).
...
def render_lineal() -> None:
    ...
    Visuelle Logo-Ersatzform — wird typischerweise im Sidebar-Header und einmal
    pro Page oben im Main-Container ausgegeben.
    """
    st.markdown(
        '<div class="bh-lineal">'
        '<div class="bh-lineal__bar"></div>'
        '<div class="bh-lineal__line"></div>'
        '<div class="bh-lineal__square"></div>'
        '</div>',
...
FAVICON_PATH: Path = Path(str(_STATIC / "favicon.svg"))
